      ...
      <aside className="dz-sidebar">
        ...
        <div className="dz-logo">
          <svg width="28" height="22" viewBox="0 0 32 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" y="8" width="4" height="16" rx="2" fill="#1ed760" opacity="0.4"/>
            <rect x="7" y="4" width="4" height="20" rx="2" fill="#1ed760" opacity="0.7"/>
            <rect x="14" y="0" width="4" height="24" rx="2" fill="#1ed760"/>
