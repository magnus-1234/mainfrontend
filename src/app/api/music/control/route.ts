...
const rawBotUrl = envValue("MUSIC_BOT_API_URL");
const BOT_API_URL = (rawBotUrl && rawBotUrl.includes("140.245.201.209")) 
  ? "https://music-dc-bot.onrender.com" 
  : (rawBotUrl || "https://music-dc-bot.onrender.com");
